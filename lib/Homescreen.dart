...
class __homescreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Container(
        color: Color.fromARGB(255, 136, 21, 21),
        child: Scaffold(
            appBar: AppBar(
              ...
              children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Ink.image(
                              image: AssetImage(
                                  "assets/head slider/attendance.jpg"),
                              height: 40,
                              width: 130,
                            ),
                          ),
                          ...
                          InkWell(
                            ...
                            child: Ink.image(
                              image: AssetImage(
                                  "assets/head slider/heirarchy.jpg"),
                              height: 40,
                              width: 139,
                            ),
                          ),
                          ...
                          InkWell(
                            ...
                            child: Ink.image(
                              image:
                                  AssetImage("assets/head slider/academic.jpg"),
                              height: 40,
                              width: 190,
                            ),
                          ),
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      top: 4, right: 8, left: 8, bottom: 5),
                  child: SizedBox(
                    child:
                        Image(image: AssetImage("assets/images/gla logo.jpg")),
                  ),
                ),
                //
                // performance chart--------------------------------------------
                    ...
                    child: Card(
                        ...
                        child: Column(
                          children: [
                            Image(
                                image: AssetImage(
                                    "assets/images/quickActions.png")),
                            //
                            // actions------------------------------------------------------
                            //
                            Row(
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Ink.image(
                                    image:
                                        AssetImage("assets/actions/result.jpg"),
                                    fit: BoxFit.cover,
                                    height: 60,
                                    width: 60,
                                  ),
